...
local function ItemCanBeExtended(item)
    if item.StatsId ~= nil then
        ...
        Ext.Print("Activated", template.Activated)
        Ext.Print("OffStage", template.OffStage)
        Ext.Print("CanBePickedUp", template.CanBePickedUp)
        Ext.Print("CanBeMoved", template.CanBeMoved)
        Ext.Print("WalkOn", template.WalkOn)
        Ext.Print("WalkThrough", template.WalkThrough)
        Ext.Print("NoCover", template.NoCover)
        Ext.Print("CanShootThrough", template.CanShootThrough)
        Ext.Print("CanUse", template.CanUse)
        Ext.Print("InteractionDisabled", template.InteractionDisabled)
        Ext.Print("Destroyed", template.Destroyed)
        Ext.Print("LoadedTemplate", template.LoadedTemplate)
        Ext.Print("IsDoor", template.IsDoor)
        Ext.Print("StoryItem", template.StoryItem)
        Ext.Print("Summon", template.Summon)
        Ext.Print("FreezeGravity", template.FreezeGravity)
        Ext.Print("ForceSync", template.ForceSync)
        Ext.Print("IsLadder", template.IsLadder)
        Ext.Print("PositionChanged", template.PositionChanged)
        Ext.Print("Totem", template.Totem)
        Ext.Print("Destroy", template.Destroy)
        Ext.Print("GMFolding", template.GMFolding)
        Ext.Print("Sticky", template.Sticky)
        Ext.Print("DoorFlag", template.DoorFlag)
        Ext.Print("Floating", template.Floating)
        Ext.Print("IsSurfaceBlocker", template.IsSurfaceBlocker)
        Ext.Print("IsSurfaceCloudBlocker", template.IsSurfaceCloudBlocker)
        Ext.Print("SourceContainer", template.SourceContainer)
        Ext.Print("Frozen", template.Frozen)
        Ext.Print("TeleportOnUse", template.TeleportOnUse)
        Ext.Print("PinnedContainer", template.PinnedContainer)
        Ext.Print("UnsoldGenerated", template.UnsoldGenerated)
        Ext.Print("IsKey", template.IsKey)
        Ext.Print("Global", template.Global)
        Ext.Print("CanConsume", template.CanConsume)
        Ext.Print("TreasureGenerated", template.TreasureGenerated)
        Ext.Print("UnEquipLocked", template.UnEquipLocked)
        Ext.Print("UseRemotely", template.UseRemotely)
